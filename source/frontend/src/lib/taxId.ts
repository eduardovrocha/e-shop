...
// junto em `dashboard/src/lib/taxId.ts` e `backend/app/services/tax_id_checksum.rb`.
...
// Limita a 14 dígitos (descarte de excesso é silencioso — mesmo padrão
// já em uso por `maskPhoneBR`).
...
// Mensagem inline para o input. `digits` cru, sem máscara.
